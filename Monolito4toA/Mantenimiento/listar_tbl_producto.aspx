<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listar_tbl_producto.aspx.cs" Inherits="Monolito4toA.Mantenimientos.listar_tbl_producto" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Gestión de Productos — Monolito Secure</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .grid-table td { padding: 18px 15px; background: rgba(255,255,255,0.02); border-top: 1px solid var(--border); border-bottom: 1px solid var(--border); font-weight: 600; color: #e2e8f0; vertical-align: middle; }
        ...
        <main class="main-content">
            <header class="top-bar">
                <div class="title-area">
                    ...
                    <p>Crea, edita, elimina o examina el inventario de productos y gestiona sus catálogos fotográficos.</p>
                </div>
                <div>
                    <a href="nuevo_tbl_producto.aspx" class="btn-modern"><i class="fa-solid fa-plus"></i> Registrar Producto</a>
                </div>
            </header>
            ...
            <div class="panel">
                <div class="grid-container">
                    <asp:GridView ID="gvProductos" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="pro_id" HeaderText="ID" ItemStyle-Width="60px" />
                            <asp:TemplateField HeaderText="Imagen" ItemStyle-Width="100px">
                                <ItemTemplate>
                                    <img src='<%# GetProductImageSrc(Eval("pro_id")) %>' style="width: 60px; height: 60px; object-fit: cover; border-radius: 12px; border: 1px solid var(--border);" alt="Producto" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="pro_nombre" HeaderText="Nombre del Producto" />
                            <asp:BoundField DataField="pro_categoria" HeaderText="Categoría" />
                            <asp:BoundField DataField="pro_cantidad" HeaderText="Stock" ItemStyle-Width="80px" />
                            ...
                            <asp:TemplateField HeaderText="Proveedor">
                                <ItemTemplate>
                                    <%# GetProviderName(Container.DataItem) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Estado" ItemStyle-Width="120px">
                                <ItemTemplate>
                                    <span class='<%# Eval("pro_estado").ToString() == "A" ? "badge badge-active" : "badge badge-inactive" %>'>
                            ...
                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="150px">
                                <ItemTemplate>
                                    <!-- Edit Link -->
                                    <a href='nuevo_tbl_producto.aspx?id=<%# Eval("pro_id") %>' class="action-link action-edit" title="Editar">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    
                                    <!-- Physical Delete -->
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="DeleteProduct" CommandArgument='<%# Eval("pro_id") %>' 
                                        CssClass="action-link action-delete" title="Eliminar Producto" 
                                        OnClientClick="return confirm('¿Está seguro de eliminar físicamente este producto y todas sus imágenes asociadas?');">
